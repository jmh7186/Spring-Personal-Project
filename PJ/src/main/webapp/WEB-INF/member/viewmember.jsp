	...
	<div class="container mt-3">
		...
		<form action="/member/updateProc" method="POST" onsubmit="return confirmsignup()">
			...
			<div class="mb-3 mt-3">
				...
				<input type="button" id="updatePwdBtn" hidden=true class="btn btn-primary" onclick="updatePwd()" value="비밀번호 변경">
				<input type="password" class="form-control" id="repwd" hidden=true name="repwd" placeholder="비밀번호 확인">
				<input type="button" class="btn btn-info" id="pcon" hidden=true onclick="_confirmpwd()" value="비밀번호 검증">
			</div>
			<div class="mb-3 mt-3">
